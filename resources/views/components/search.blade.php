<div class="mb-4 ">
    <div class="relative">
      <input {{ $attributes }} type="destination" class="block w-full px-4 py-3 text-sm bg-gray-100 rounded-lg border-grey-300 peer ps-11 focus:border-indigo-500 focus:ring-indigo-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-700 dark:border-transparent dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600">
